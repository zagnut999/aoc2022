...
internal class Tests
{
    ...
    private class Crt
    {
        ...
        public Crt(IAmTicker clock, Cpu cpu)
        {
            _cpu = cpu;
    ...
    private class Clock : IAmTicker
    {
        ...
        protected virtual void OnTickStart(TickEventArgs args)
        {
            OnTickStarted?.Invoke(this, args);
        }

        protected virtual void OnTickEnd(TickEventArgs args)
        {
